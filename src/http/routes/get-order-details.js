...
var not_a_manager_error_1 = require("./errors/not-a-manager-error");
exports.getOrderDetails = new elysia_1.default().use(authentication_1.authentication).get('/orders/:id', function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
    var orderId, restaurantId, order;
    var getCurrentUser = _b.getCurrentUser, params = _b.params;
