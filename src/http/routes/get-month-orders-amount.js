...
exports.getMonthOrdersAmount = void 0;
...
exports.getMonthOrdersAmount = new elysia_1.default()
    .use(authentication_1.authentication)
    .get('/metrics/month-orders-amount', function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
