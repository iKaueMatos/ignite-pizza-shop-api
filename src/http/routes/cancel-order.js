...
exports.cancelOrder = new elysia_1.default().use(authentication_1.authentication).patch('/orders/:id/cancel', function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
    var orderId, restaurantId, order;
    var getCurrentUser = _b.getCurrentUser, set = _b.set, params = _b.params;
